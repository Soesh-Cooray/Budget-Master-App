        ...
        {budgets.length === 0 ? (
          ...
          budgets.slice(0, 4).map((budget) => {
            ...
            return (
              <div
                key={budget.id}
                className="p-3.5 rounded-xl bg-slate-800/40 border border-slate-700/60 hover:border-slate-600/80 transition-all space-y-2.5"
              >
                <div className="flex items-center justify-between">
                ...
                <div className="w-full h-2.5 bg-slate-900/80 rounded-full overflow-hidden p-0.5 border border-slate-700/50">
                  <div
