...
export function HomePage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-indigo-500/30 selection:text-indigo-300 flex flex-col font-sans transition-colors duration-300 overflow-x-hidden">
      {/* Top Navigation Bar */}
      <header className="sticky top-0 z-40 w-full glass-panel border-b border-slate-800/80 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 to-indigo-400 flex items-center justify-center text-white shadow-md shadow-indigo-600/30 transition-transform group-hover:scale-105">
          ...
          <div>
            ...
            <span className="text-[10px] font-semibold text-slate-400 tracking-wider uppercase block leading-tight">
              Personal Finance
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/signin"
            className="text-xs sm:text-sm font-semibold text-slate-300 hover:text-white px-3 py-2 rounded-xl transition-colors"
          >
            Sign In
          </Link>
          <Link to="/signup">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-2">
              <Link to="/signup" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto rounded-2xl font-bold flex items-center gap-2 shadow-xl shadow-indigo-600/30">
                  <span>Start Free Today</span>
                  <ArrowRight className="w-4 h-4" />
                </Button>
              </Link>
              <Link to="/signin" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-2xl font-semibold border-slate-700 hover:bg-slate-800/80">
                  Sign In to Account
                </Button>
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500/30 to-emerald-500/30 rounded-3xl blur-xl opacity-75 animate-pulse" />

              <Card className="relative z-10 p-6 sm:p-7 space-y-5 border border-slate-700/80 bg-slate-900/90 shadow-2xl">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div>
                    <h3 className="text-lg font-bold text-white tracking-tight">
                      Budget Allocation
                    </h3>
                    <p className="text-xs text-slate-400">Monthly Targets & Spend Rate</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      <span className="text-slate-200">Housing & Utilities</span>
                      <span className="font-mono tabular-nums text-slate-400">$1,450 / $1,800</span>
                    </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      <span className="text-slate-200">Groceries & Dining</span>
                      <span className="font-mono tabular-nums text-slate-400">$480 / $700</span>
                    </div>
                    <div className="w-full h-2.5 rounded-full bg-slate-950 overflow-hidden border border-slate-800 p-0.5">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      <span className="text-slate-200">Leisure & Travel</span>
                      <span className="font-mono tabular-nums text-slate-400">$290 / $350</span>
                    </div>
                    <div className="w-full h-2.5 rounded-full bg-slate-950 overflow-hidden border border-slate-800 p-0.5">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-indigo-500/15 text-indigo-400 border border-indigo-500/25 flex items-center justify-center">
                      <PiggyBank className="w-5 h-5" />
                    </div>
                    <div>
                      <span className="text-xs font-bold text-slate-200 block">Emergency Reserve</span>
                      <span className="text-[11px] text-slate-400">Target reached: 85%</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-mono font-bold text-emerald-400 tabular-nums block">
                      $12,000.00
                    </span>
                    <span className="text-[10px] text-slate-400 uppercase tracking-wider">Saved</span>
                  </div>
                </div>
              </Card>
            </div>
        ...
        <section className="mt-20 sm:mt-28 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {/* Feature 1 */}
            <Card className="hover:border-slate-700/80 transition-all p-6 space-y-3">
              ...
              <h3 className="font-bold text-base text-slate-100">Expense Tracking</h3>
            ...
            <Card className="hover:border-slate-700/80 transition-all p-6 space-y-3">
              ...
              <h3 className="font-bold text-base text-slate-100">Budget Health</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <Card className="hover:border-slate-700/80 transition-all p-6 space-y-3">
              ...
              <h3 className="font-bold text-base text-slate-100">Financial Reports</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
      ...
      {/* Modern Footer */}
      <footer className="w-full glass-panel border-t border-slate-800/80 py-8 px-4 text-center mt-16 space-y-2">
        <div className="flex items-center justify-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-indigo-600/30 flex items-center justify-center text-indigo-400">
            <Wallet className="w-4 h-4" />
          </div>
          <span className="font-bold text-sm text-slate-200">BudgetMaster</span>
        </div>
